...
public class TriangleGradientPicker {
    ...
    public TriangleGradientPicker(int scale) {
        this.scale = scale;
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY,int x,int y,float angle) {
        ...
        HybridRenderer2D.drawTriangle(new Quad(x, y, scale, scale), activePickerColor);
    ...
    public void mouseClicked(MouseButtonEvent mouseButtonEvent) {
        if (mouseButtonEvent.button() == 0) {
            ...
            Color activePickerColor = Color.GREEN;
            drawTriangleAndSample(null, new Quad(15, 14, 50, 50), activePickerColor, clickX, clickY, true, true);
        }
    }
